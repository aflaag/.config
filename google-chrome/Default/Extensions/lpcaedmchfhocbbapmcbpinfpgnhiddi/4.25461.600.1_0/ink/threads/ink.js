...
var ASM_CONSTS = {
  318336: ($0, $1, $2, $3) => setTimeout(() => window.inkWasmRegistry[$3].dynCalls["vi"]($1, $2), $0),
  318421: $0 => {
    clearTimeout($0);
  },
  318443: ($0, $1) => {
  ...
  318873: $0 => window.inkHostRegistry[$0].shouldPreloadShaders(),
  318935: $0 => window.inkHostRegistry[$0].shouldRegisterDocument(),
  318999: ($0, $1, $2, $3, $4, $5) => {
